...
- Supporting the latest [EcmaScript](https://ecma-international.org/) features and feature proposals such as [Export Default From](https://github.com/tc39/proposal-export-default-from), [Export Namespace From](https://github.com/tc39/proposal-export-ns-from), [Logical Assignment](https://github.com/tc39/proposal-logical-assignment), [Nullish Coalescing](https://github.com/tc39/proposal-nullish-coalescing) and [Optional Chaining](https://github.com/tc39/proposal-optional-chaining).
